fun calculateSimilarityScore(input: String): Int {
    ...
    return leftList.sumOf { left -> left * (rightCount[left] ?: 0) }
}
...
fun main() {
    ...
    val similarityScore = calculateSimilarityScore(input)
    println("The similarity score between the lists is: $similarityScore")
}
